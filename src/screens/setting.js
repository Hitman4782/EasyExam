    ...
    const fetchUserDetails = async () => {
      try {
        ...
        if (user) {
          ...
          if (userDoc.exists) {
            const { fullName, class: userClass } = userDoc.data();
            setUserDetails({ displayName, email, fullName, class: userClass });
          }
        }
      } catch (error) {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.profileContainer}>
        ...
        <View style={styles.profileBox}>
          <Text style={styles.profileHeading}>Class:</Text>
          <Text style={styles.profileText}>{userDetails?.class}</Text>
        </View>
      </View>
      ...
      <TouchableOpacity style={styles.sectionButton} onPress={() => navigation.navigate('Edit Profile')}>
